  ...
  Widget build(BuildContext context) {
    return MultiRepositoryProvider(
      ...
      child: MultiBlocProvider(
        providers: [
          BlocProvider(create: (context) => BattlePassCubit(context.read<BattlePassRepository>())..load()),
          BlocProvider(create: (context) => TasksCubit(context.read<TasksRepository>())..load()),
        ],
