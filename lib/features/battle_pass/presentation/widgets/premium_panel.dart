          ...
          child: Column(
            children: [
              Text(
                ...
                style: TextStyle(color: const Color(0xFFFFD149), fontSize: 36.r, fontWeight: FontWeight.w600, height: 1.30, letterSpacing: -0.36.r),
              ),
              SizedBox(height: 1.r),
              SizedBox(
                width: 400.r,
                child: Text(
                  ...
                  textAlign: TextAlign.center,
                  style: TextStyle(color: AppColors.white70, fontSize: 22.r, fontWeight: FontWeight.w500, height: 1.20, letterSpacing: -0.22.r),
                ),
              ),
              SizedBox(height: maxed ? 27.r : 53.r),
              if (maxed) ...[
                const _MaxLevelButton(),
                if (canClaimAll) ...[SizedBox(height: 24.r), _ClaimAllRewardsButton(onPressed: onClaimAll)],
              ] else if (canClaimAll)
        ...
        child: Padding(
          ...
          child: Center(
            child: Text(
              ...
              textAlign: TextAlign.center,
              style: TextStyle(color: const Color(0x66E9E9F3), fontSize: 22.r, fontWeight: FontWeight.w500, height: 1.20, letterSpacing: -0.22.r),
            ),
          ),
        ),
      ),
