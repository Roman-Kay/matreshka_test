...
class _RewardRailState extends State<RewardRail> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _availableRewardGlowController = AnimationController(vsync: this, duration: const Duration(milliseconds: 4500))..repeat();
  }
      ...
      builder: (context, child) {
        return LayoutBuilder(
          builder: (context, constraints) {
            ...
            final shouldReleaseTrailingSpace = _shouldReleaseTrailingSpace() || _isAtFinalRewardEnd(premiumLocked, visibleEndLevel, pass.season.maxLevel, constraints.maxWidth);
            final isAtScrollEnd = _isAtScrollEnd() || shouldReleaseTrailingSpace;
            ...
            final effectiveRailRightInset = shouldReleaseTrailingSpace ? 0.0 : _premiumPanelReservedWidth.h;
              ...
              children: [
                Positioned.fill(
                  ...
                  child: ShaderMask(
                    ...
                    child: ClipRect(
                      clipper: const _RailGlowClipper(leftInset: 1, rightInset: 0, verticalOverflow: 96),
                      child: ListView.builder(
                        controller: _scrollController,
                        clipBehavior: Clip.none,
                        padding: EdgeInsets.fromLTRB(_railListPadding.w, 0, effectiveListTrailingPadding, 0),
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final isLastSeasonLevel = showingSeasonEnd && level.number >= pass.season.maxLevel;
                          return Stack(
                            clipBehavior: Clip.none,
                            children: [
                              RewardCard(
                                ...
                                availableGlowAnimation: _availableRewardGlowController,
                              ),
                      ...
                      child: AnimatedSwitcher(
                        ...
                        child: pinnedPrize == null || pinnedPrizeReward == null
                            ...
                            : _PinnedBigPrizeCard(
                                ...
                                progress: pass.progress,
                                rewardStatus: pass.rewardStatus(pinnedPrizeReward.id),
                                premiumStatus: pass.premiumStatus,
  ...
  int _visibleEndLevel(PlayerBattlePassProgress progress, int maxLevel, bool premiumLocked) {
  ...
  bool _shouldReleaseTrailingSpace() {
    if (!_scrollController.hasClients) return false;
    return _scrollController.position.extentAfter <= _premiumPanelReservedWidth.h + _railTrailingInset.h + _rewardItemExtent.h * _trailingReleaseLookaheadItems;
  }
  ...
  double _pinnedPrizeLeft(int level, double pinLeft, bool premiumLocked, double dockingProgress) {
    ...
    final targetLeft = _bigPrizeLeftInViewport(premiumLocked, level) + _pinnedPrizeDockingOffset.h;
  ...
  void _showRewardDetails({
    ...
    showModalBottomSheet<void>(
      ...
      builder: (_) =>
          RewardDetailsSheet(reward: reward, rewardStatus: rewardStatus, choiceRewards: choiceRewards, level: level, premiumStatus: premiumStatus, onClaim: () => widget.onClaimReward(reward.id)),
    );
  }
}
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          ...
          Positioned(
            left: 144.h,
            child: Image.asset(AppAssets.dotedLine, width: 196.h, fit: BoxFit.fill),
          ),
          Positioned(
            left: 318.h,
...
class _RailGlowClipper extends CustomClipper<Rect> {
  const _RailGlowClipper({required this.leftInset, required this.rightInset, required this.verticalOverflow});
  ...
  Rect getClip(Size size) {
    return Rect.fromLTRB(leftInset, -verticalOverflow, size.width - rightInset, size.height + verticalOverflow);
  }

  @override
  bool shouldReclip(_RailGlowClipper oldClipper) {
    return oldClipper.leftInset != leftInset || oldClipper.rightInset != rightInset || oldClipper.verticalOverflow != verticalOverflow;
  }
}
    ...
    return Opacity(
      ...
      child: RewardCard(
        ...
        onShowDetails: () => showModalBottomSheet<void>(
          context: context,
          backgroundColor: AppColors.ink,
          builder: (_) => RewardDetailsSheet(reward: reward, rewardStatus: rewardStatus, choiceRewards: const [], level: level, premiumStatus: premiumStatus, onClaim: () => onClaimReward(reward.id)),
        ),
        showRoadLines: false,
        forceLargeSize: true,
